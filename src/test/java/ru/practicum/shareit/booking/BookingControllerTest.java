...
public class BookingControllerTest {
    ...
    @Test
    void testCreateBookingFailItemId() throws Exception {
        BookingRequestDto requestDto = new BookingRequestDto();
        requestDto.setItemId(0L);
        requestDto.setStart(LocalDateTime.now().plusDays(2));
        requestDto.setEnd(LocalDateTime.now().plusDays(3));
    ...
    @Test
    void testCreateBookingFailStartDate() throws Exception {
        BookingRequestDto requestDto = new BookingRequestDto();
        requestDto.setItemId(1L);
        requestDto.setStart(LocalDateTime.now().minusDays(2));
        requestDto.setEnd(LocalDateTime.now().plusDays(3));
    ...
    @Test
    void testCreateBookingFailEndDate() throws Exception {
        BookingRequestDto requestDto = new BookingRequestDto();
        requestDto.setItemId(1L);
        requestDto.setStart(LocalDateTime.now().plusDays(2));
